 ...
 */
@Autonomous(name = "Red_Center", group = "Red")
public class Red_Center extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(red > blue){
            ...
            robot.jewel_arm.setPosition(arm_up);
            sleep(200);
            DriveStraight(2610, 0.25);//Drive Off far enough to line up with cryptobox
        ...
        if (blue > red){
            ...
            robot.jewel_arm.setPosition(arm_up);
            sleep(100);
            DriveStraight(1450, 0.3);//drive to line up with cryptobox
        ...
        if (blue == red){
            robot.jewel_arm.setPosition(arm_up);
            sleep(1000);
            DriveStraight(2450, .25);//Drive Off
        }
        sleep(100);
        ...
        robot.liftl.setPower(.5);
        robot.liftr.setPower(.5);
        GyroTurn(85,.25);//Turn 90 DEGREES
        sleep(100);
        ...
        robot.right_rear_drive.setPower(.1);
        robot.left_front_drive.setPower(.1);
        robot.left_rear_drive.setPower(.1);
        sleep(1200);
        robot.intakel.setPower(1);
